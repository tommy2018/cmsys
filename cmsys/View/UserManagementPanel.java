...
public class UserManagementPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        changePasswordPanelLayout.setHorizontalGroup(
            ...
            .addGroup(changePasswordPanelLayout.createSequentialGroup()
                ...
                .addGroup(changePasswordPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(confirmNewPasswordTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 218, Short.MAX_VALUE))
        ...
        changeToComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Administrator", "Normal user", "Author", "PC member", "PC chair" }));

        changePermissionButton.setText("Change");
        changePermissionButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(changeToComboBox, 0, 306, Short.MAX_VALUE))
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(currentRoleDesLabel)
                    .addComponent(currentRoleLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(changeToDesLabel)
        ...
        resultPanelLayout.setVerticalGroup(
            ...
            .addGroup(resultPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(optionsTabbedPane, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
                ...
                SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                    ...
                    protected void done() {
                        if (user != null) {
                            ...
                            String role = Role.toString(user.getRole());
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        String username = keywordTextField.getText().trim();
        ArrayList<User> userList = User.searchUserByUsername(username);
        
        Object[][] userObj = null; 
        userObj = new Object[userList.size()][4];
        
        for(int i = 0; i < userList.size(); i++) {
            userObj[i][0] = userList.get(i).getUID();
            userObj[i][1] = userList.get(i).getUsername();
            userObj[i][2] = userList.get(i).getFirstName();
            userObj[i][3] = userList.get(i).getLastName();
        }
        
        model = (new javax.swing.table.DefaultTableModel(userObj, new String [] {"UID", "Username", "Firstname", "Lastname"}) {
    				private static final long serialVersionUID = -7209182869872950816L;
    					...
    					try {
    						...
    						if (confirmPassword.equals(password)) {
    							if (confirmPassword.length() < 8)
                                    ...
                                    Dialog dialog = new Dialog(this, "Changing password...");
                                    ...
                                    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                                        ...
                                        protected Void doInBackground() {
                                            try {
                                                ...
                                                dialog.close();
                                                MessageBox.error("Unable to change the password at the moment.", me);
                                            }
                                            return null;
                                        }
    ...
    private void changePermissionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changePermissionButtonActionPerformed
        // TODO add your handling code here:
        if(changeToComboBox.getSelectedIndex() == -1) {
            return;
        } else {
            final JPanel self = this;
            int role = changeToComboBox.getSelectedIndex();
            int selectedRow = usersTable.convertRowIndexToModel(usersTable.getSelectedRow());
            int uid = (int)(usersTable.getModel().getValueAt(selectedRow, 0));
            changePermissionButton.setEnabled(false);
            
            Dialog dialog = new Dialog(this, "Changing role...");
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                ...
                protected Void doInBackground() {
                    try {
                        ...
                        dialog.close();
                        MessageBox.error("Unable to change the role at the moment.", me);
                    }
                    return null;
                }
    ...
    }//GEN-LAST:event_changePermissionButtonActionPerformed
