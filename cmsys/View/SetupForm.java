...
import cmsys.UserManagement.Register;


public class SetupForm extends javax.swing.JPanel {

	private static final long serialVersionUID = 7992337903310982663L;
    public SetupForm() {
        initComponents();
    }
    private void initComponents() {
        ...
        jLabel1.setText("<html><b>Welcome! The enter the following information in order to set-up the system.<br>All settings will be set to its default value, if you want to modify these settings, please go to System setting.</b></html>");

        jLabel2.setText("Admin username:");

        jLabel3.setText("Admin password:");

        jButton1.setText("Setup now");

        jLabel4.setText("Submission deadline (days after today): ");
