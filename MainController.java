	...
	static public void main(String[] args) {
		try {
            ...
            else if(command.equals("2"))
            {
                ...
                Register.newUser(newUsername, newPassword, newEmail, newFname, newLname);
            }
